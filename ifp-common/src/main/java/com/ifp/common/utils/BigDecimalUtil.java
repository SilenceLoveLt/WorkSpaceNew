 ...
 * BigDecimal 类型转换工具�?
 *
 * @author：chengcs 2014�?12�?22�? 下午4:54:32
 */
public class BigDecimalUtil {
	...
	public static final Integer decimalScale = 4;// 默认位数
	...
	/**
	 * 将big数�?�设置固定的小数位转化成字符串返回�?? 1.如果big为空，则返回空；
	 * 2.如果小数位小于零，则直接处理数�?�的字符串形式，否则设置数�?�的小数位； 3.如果不过滤末尾零，则直接返回，否则删除末尾零�?
	 *
	 * @param num
	 *            数�??
	 * @param scale
	...
	public static BigDecimal multiply(Object o1, Object o2) {
		return BigDecimalUtil.obj2big(o1).multiply(BigDecimalUtil.obj2big(o2));
	}
	...
	/**
	 * 用辗转相除法求取两个数之间的�?大公约数,两个整数才有意义 2012�?12�?30�?14:42:15 许小波添�?
	 */
	public static BigDecimal getCommonDenominator(Object o1, Object o2) {
		BigDecimal b1 = BigDecimalUtil.obj2big(o1);
		BigDecimal b2 = BigDecimalUtil.obj2big(o2);
	...
	/**
	 * 从第�?个不为零的开始，到下�?个不为零的为止，将之间的认为是数值进行解析；
	 *
	 * @param numStr
	 *            源字符串
	 * @return
	...
	public static void main(String[] args) {
		System.out.println(BigDecimalUtil.toBigDecimalFour(BigDecimal.valueOf(10.24356d)));
		System.out.println(BigDecimalUtil.toBigDecimalFour(BigDecimal.valueOf(10.243d)));
