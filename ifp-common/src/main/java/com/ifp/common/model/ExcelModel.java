...
public class ExcelModel implements Serializable {
    ...
    //当前是第几个sheet页?
    @ApiModelProperty("sheet页数")
	private String sheetNumber;
	//sheet页的名称
    @ApiModelProperty("sheet页的名称")
    private String sheetName;
	//excel名称
    @ApiModelProperty("excel名称")
    private String excelName;
	//导入开始行
    @ApiModelProperty("导入开始行")
    private String beginNum;
	//导入结束行数
    @ApiModelProperty("导入结束行数")
    private String endNum;
	//导入开始列
    @ApiModelProperty("导入开始列")
    private String beginCol;
	//导入结束列数
    @ApiModelProperty("导入结束列数")
